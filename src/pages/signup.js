    ...
    <AuthLayout>
      <div className="z-20 w-full max-w-sm">
        ...
        <form action="" className='w-full' onSubmit={onSubmitSignUp} ref={form}>
          ...
          <div className="mt-3 flex justify-start cursor-pointer" onClick={() => setAgreeToTerms(!agreeToTerms)}>
          ...
          <div className="mt-3 text-center">
            <p className="text-white text-inter font-inter">
              ...
              <Link href='/signin'>
                <a>
                  <span className="font-semibold foot-link font-base">Sign In</span>
                </a>
              </Link>
            </p>
          </div>
