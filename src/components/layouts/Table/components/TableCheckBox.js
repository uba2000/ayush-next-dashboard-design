    ...
    return (
      <>
        <div className="relative">
          <input type="checkbox" ref={resolvedRef} {...rest} className='peer absolute w-full h-full z-20 opacity-0' />
          ...
          <div className="pop-in-animation hidden peer-checked:inline-block">
            <svg width="24" height="24" className='tick-svg' viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
