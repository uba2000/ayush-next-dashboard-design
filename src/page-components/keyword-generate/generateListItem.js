...
const GenerateListItem = ({ content, triggerComplete, index }) => {
      ...
      {openSmallPreview && (
        <Table.Row className="table-row cursor-default relative overflow-hidden pt-[25px] pb-[30px] h-[315px] w-full border-b dark:border-b-darkMode-border border-b-ash border-b-solid">
          ...
          <div className="table-cell line-clamp-10 pt-[25px]">
            ...
            excepturi, nihil ea magnam totam quo recusandae eveniet soluta?
            Consectetur cupiditate animi ducimus, quos quia nemo voluptates modi
            maxime eos odit. Lorem ipsum dolor sit, amet consectetur adipisicing
            elit.Eos excepturi, nihil ea magnam totam quo recusandae eveniet
            soluta? Consectetur cupiditate animi ducimus, quos quia nemo
            voluptates modi maxime eos odit. Lorem ipsum dolor sit, amet
            consectetur adipisicing elit. Eos excepturi, nihil ea magnam totam
            quo recusandae eveniet soluta? Consectetur cupiditate animi ducimus,
            quos quia nemo voluptates modi maxime eos odit. Lorem ipsum dolor
            sit, amet consectetur adipisicing elit. Eos excepturi, nihil ea
            magnam totam quo recusandae eveniet soluta? Consectetur cupiditate
            animi ducimus, quos quia nemo voluptates modi maxime eos odit. Lorem
            ipsum dolor sit, amet consectetur adipisicing elit. Eos excepturi,
            nihil ea magnam totam quo recusandae eveniet soluta? Consectetur
            cupiditate animi ducimus, quos quia nemo voluptates modi maxime eos
            odit. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eos
            excepturi, nihil ea magnam totam quo recusandae eveniet soluta?
            Consectetur cupiditate animi ducimus, quos quia nemo voluptates modi
            maxime eos odit. Lorem ipsum dolor sit, amet consectetur adipisicing
            elit. Eos excepturi, nihil ea magnam totam quo recusandae eveniet
            ...
            elit. Eos excepturi, nihil ea magnam totam quo recusandae eveniet
            soluta? Consectetur cupiditate animi ducimus, quos quia nemo
            voluptates modi maxime eos odit.
          </div>
