        ...
        <div className="p-6 pl-[27px] space-y-[10px]">
          <BetweenStyle>
            <span className="font-medium text-xl">
              Change my limit to {fNumber(noOfAddOns)} keywords
            </span>
          ...
          <div className="space-y-3">
            ...
            <div className="text-center">
              <span className="font-medium text-xs">
                Additional taxes may apply depending on your country of
                residence.
              </span>
            </div>
          </div>
        ...
        <div className="text-left space-y-5">
          {noOfAddOns > 0 && (
            <p className="font-medium text-xl space-y-2 flex flex-col">
              ...
              <span>
                What’s next in processing your shiny new Rank Tracker Pro
                upgrade:
                <br />
                <br />
                1. You'll get a pro-rated charge today based on the number of
                days remaining in this billing cycle.
                <br />
                <br />
                2. Starting from your next billing cycle, your monthly payments
                will be {fNumber(price)} USD.
              </span>
            </p>
          )}
