...
const FacebookHeadlines = ({ explorerState, dispatch, generate }) => {
  return (
    <FormLayout
      subText={'Write catchy and convincing headlines to make your Facebook Ads stand out.'}
      generate={generate}
      data={{
