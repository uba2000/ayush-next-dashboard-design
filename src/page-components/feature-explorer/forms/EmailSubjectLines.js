...
const EmailSubjectLines = ({ explorerState, dispatch, generate }) => {
  return (
    <FormLayout
      subText={'Generate catchy and optimized email subject lines for your business.'}
      generate={generate}
      data={{
    ...
    >
      ...
      <FormGroup label={<LabelLayout>Product Name:</LabelLayout>} labelFor={'productName'}>
        <Input
          ...
          id={'productName'}
          placeholder="seocontent.ai, google"
          className="rounded"
        />
      </FormGroup>
