...
const GoogleAdsHeadlines = ({ explorerState, dispatch, generate }) => {
  return (
    <FormLayout
      subText={'Write catchy 30-character headlines to promote your product with Google Ads.'}
      generate={generate}
      data={{
