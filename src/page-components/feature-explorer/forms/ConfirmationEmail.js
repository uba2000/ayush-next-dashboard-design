...
const ConfirmationEmail = ({ explorerState, dispatch, generate }) => {
  return (
    <FormLayout
      subText={'Write emails to re-engage customers and bring them back to your business.'}
      generate={generate}
      data={{
        ...
        confirmationOf: explorerState.specialInput1
      }}
    >
      ...
      <ExplorerTwoInputLayout>
        <FormGroup label={<LabelLayout>Confirmation of:</LabelLayout>} labelFor={'productName'}>
          <Input
