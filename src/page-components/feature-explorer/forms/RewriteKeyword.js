...
const RewriteKeyword = ({ explorerState, dispatch, generate }) => {
  return (
    <FormLayout
      subText={'Write the general idea of your next blog post. Outlining made easier and faster.'}
      generate={generate}
      data={{
    ...
    >
      ...
      <FormGroup label={<LabelLayout>Keyword:</LabelLayout>} labelFor={'keyword'}>
        <Input
