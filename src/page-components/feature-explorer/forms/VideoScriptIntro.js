...
const VideoScriptIntro = ({ explorerState, dispatch, generate }) => {
  return (
    <FormLayout
      subText={'Generate cool, creative, and catchy names for your startup in seconds.'}
      generate={generate}
      data={{
