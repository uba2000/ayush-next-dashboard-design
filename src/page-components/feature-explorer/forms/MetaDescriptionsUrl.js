...
const MetaDescriptionsUrl = ({ explorerState, dispatch, generate }) => {
  return (
    <FormLayout
      subText={'Generate SEO-optimized meta descriptions based on the content of a URL.'}
      generate={generate}
      data={{
