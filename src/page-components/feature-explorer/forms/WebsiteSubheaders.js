...
const WebsiteSubheaders = ({ explorerState, dispatch, generate }) => {
  return (
    <FormLayout
      subText={'Write a secondary headline that elaborates on the main headline.'}
      generate={generate}
      data={{
