...
const FeatureBenefit = ({ explorerState, dispatch, generate }) => {
  return (
    <FormLayout
      subText={'A feature is what something is, and a benefit is what users can do or accomplish with it.'}
      generate={generate}
      data={{
