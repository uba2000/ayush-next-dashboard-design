        ...
        >
          <div className="mx-auto" style={{ maxWidth: '737px' }}>
            ...
            <div className="mt-5 grid md:grid-cols-3 gap-4 grid-cols-2">
              <div className="">
                <button style={this.btnStyle} className="btn btn-primary bg-primary md:px-[72.17px] px-4 w-full text-white">Back</button>
              </div>
              <div className="flex items-center justify-center cursor-pointer" onClick={this.refreshHandler}>
