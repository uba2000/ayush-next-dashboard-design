        ...
        <div className="relative">
          <div className="mb-4 grid md:grid-cols-[37.31%_auto] grid-cols-1 gap-4 generator-main-header">
            <div className="flex items-start">
              {/* icon */}
              <span className='mr-4' onClick={this.checkedHandler}>
                {!this.state.checked ? (
                  <span className="block cursor-pointer w-[19.74px] h-[20.55px] rounded border border-solid border-primary"></span>
                ) : (
                  <span className="block cursor-pointer pop-in-animation">
              ...
              <span className='ml-4 flex flex-col'>
                <span className='headerTitleStyle'>Keywords Name</span>
                <span className='headerTitleStyle'>How to learn music </span>
              </span>
            </div>
            <div className="flex ml-auto">
              <div className="flex flex-col mr-3">
                <span className='headerDetailsStyles'>Grammarly Score</span>
                <span className='text-primary headerDetailsValueStyles'>96 percent ( % )</span>
              </div>
              <div className="flex flex-col mr-3">
                <span className='headerDetailsStyles'>Keywords Density</span>
                <span className='text-primary headerDetailsValueStyles'>92 percent ( % )</span>
              </div>
              <div className="flex flex-col mr-3">
                <span className='headerDetailsStyles'>Words count</span>
                <span className='headerDetailsValueStyles'>160 Words</span>
              </div>
            </div>
          </div>
