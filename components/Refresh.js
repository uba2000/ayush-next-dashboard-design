...
export const Refresh = React.forwardRef(
  ({ isPrimary, isWhite, className, ...rest }) => {
    ...
    return (
      <div className="flex items-center cursor-pointer" onClick={refreshHandler}>
        <svg width="20" height="14" {...rest} className={`${load ? 'spinning-loader' : ''} ${className ? className : ''}`} viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
